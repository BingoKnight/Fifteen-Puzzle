...
function NavBar(props) {
    ...
    function ToggleGame() {
        if ($('#game-btn').hasClass('idle')) {
            ...
            $('#difficulty-toggle').addClass('disabled');
        ...
        <nav className="navbar navbar-expand-xl align-content-end" id={"navbar"}>
            <div className="container-fluid">
                <ul className="nav navbar-nav" id={"action-buttons"}>
                    <li>
                        <button id={'game-btn'} className="btn btn-primary idle" onClick={() => ToggleGame()}>Start
                            Game
                        </button>
                    </li>
                    <li>
                        <button id={'pause-btn'} className="btn btn-secondary paused disabled"
                                onClick={() => TogglePause(null)}>Resume
                        </button>
                    </li>
                    <li>
                        <button id={'difficulty-toggle'} className="btn btn-danger" onClick={props.ToggleMode}>Hard
                            Mode
                        </button>
                    </li>
                </ul>
